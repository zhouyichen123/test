...
weights = [
    {
        ...
        "dest": "/root/autodl-tmp/model/MLLM/llava-v1.5-7b",
        # git commit hash from huggingface
        "src": "/root/autodl-tmp/model/MLLM/llava-v1.5-7b",
...
class Predictor(BasePredictor):
    def setup(self) -> None:
        ...
        self.tokenizer, self.model, self.image_processor, self.context_len = load_pretrained_model("/root/autodl-tmp/model/MLLM/llava-v1.5-7b", model_name="llava-v1.5-7b", model_base=None, load_8bit=False, load_4bit=False)
...
if __name__ == "__main__":
    pred = Predictor()
    result =pred.predict("/root/merlion.png","Please describe the image",top_p=3,temperature=0.3,max_tokens=512)
    print(result)